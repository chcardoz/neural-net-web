...
var Stats = function () {
    ...
    p = a.getContext("2d");
    p.fillStyle =
        "rgb(" + b.fps.bg.r + "," + b.fps.bg.g + "," + b.fps.bg.b + ")";
    ...
    i.style.color =
        "rgb(" + b.ms.fg.r + "," + b.ms.fg.g + "," + b.ms.fg.b + ")";
    ...
    j.style.backgroundColor =
        "rgb(" +
        Math.floor(b.mem.bg.r / 2) +
        "," +
        Math.floor(b.mem.bg.g / 2) +
        "," +
        Math.floor(b.mem.bg.b / 2) +
        ")";
    ...
    k.style.color =
        "rgb(" + b.mem.fg.r + "," + b.mem.fg.g + "," + b.mem.fg.b + ")";
